...
<div class="container">
    ...
    <div class="col-lg-5 col-md-6 mb-4 mb-md-0">
        ...
        <img class="img-fluid w-100" src="{{ asset('user_assets/images/musfiqur.jpg') }}">
        </div>
    </div>
    <div class="col-lg-5 col-md-6">
        <div class="content pl-lg-3 pl-0">
        <h2 id="helllo-im-richi-andorn-im-a-biography-based-researcher-and-author">Helllo I’m Musfiqur Rahman. I’m a Computer Engineer</h2>
...
<img src="{{ asset('user_assets/images/backgrounds/wave-bg.svg') }}" class="wave-bg">
<div class="container">
    ...
    <div class="col-lg-4 col-md-6">
        <img src="{{ asset('user_assets/images/mission.png') }}" class="img-fluid">
    </div>
    </div>
</div>
...
<div class="container">
    ...
    <div class="col-lg-3 col-md-4 col-sm-6">
        ...
        <a href="#!">
            ...
            <img src="{{ asset('user_assets/images/books/01.jpg') }}" alt="" class="card-img-top rounded-0">
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-3 col-md-4 col-sm-6">
        ...
        <a href="#!">
            <div class="book-cover">
            <img src="{{ asset('user_assets/images/books/02.jpg') }}" alt="" class="card-img-top rounded-0">
            </div>
            <div class="card-body">
                <h4 class="text-uppercase mb-3">Book of Earth</h4>
                <p class="h4">$25.00</p>
    ...
    <div class="col-lg-3 col-md-4 col-sm-6">
        ...
        <a href="#!">
            <div class="book-cover">
            <img src="{{ asset('user_assets/images/books/03.jpg') }}" alt="" class="card-img-top rounded-0">
            </div>
            <div class="card-body">
                <h4 class="text-uppercase mb-3">Book of Earth</h4>
                <p class="h4">$25.00</p>
    ...
    <div class="col-lg-3 col-md-4 col-sm-6">
        ...
        <a href="#!">
            <div class="book-cover">
            <img src="{{ asset('user_assets/images/books/04.jpg') }}" alt="" class="card-img-top rounded-0">
            </div>
            <div class="card-body">
                <h4 class="text-uppercase mb-3">Book of Earth</h4>
                <p class="h4">$25.00</p>
...
<div class="container">
    ...
    <div class="col-lg-10 mx-auto text-center">
        ...
        <li class="list-inline-item"><img class="img-fluid" src="{{ asset('user_assets/images/logos/logo-1.png') }}"></li>

        <li class="list-inline-item"><img class="img-fluid" src="{{ asset('user_assets/images/logos/logo-2.png') }}"></li>

        <li class="list-inline-item"><img class="img-fluid" src="{{ asset('user_assets/images/logos/logo-3.png') }}"></li>

        <li class="list-inline-item"><img class="img-fluid" src="{{ asset('user_assets/images/logos/logo-4.png') }}"></li>

        <li class="list-inline-item"><img class="img-fluid" src="{{ asset('user_assets/images/logos/logo-5.png') }}"></li>

        <li class="list-inline-item"><img class="img-fluid" src="{{ asset('user_assets/images/logos/logo-6.png') }}"></li>

        <li class="list-inline-item"><img class="img-fluid" src="{{ asset('user_assets/images/logos/logo-7.png') }}"></li>

        <li class="list-inline-item"><img class="img-fluid" src="{{ asset('user_assets/images/logos/logo-8.png') }}"></li>

        <li class="list-inline-item"><img class="img-fluid" src="{{ asset('user_assets/images/logos/logo-9.png') }}"></li>
